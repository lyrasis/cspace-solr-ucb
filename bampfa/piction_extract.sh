...
SERVER="dba-postgres-prod-45.ist.berkeley.edu port=5415 sslmode=prefer"
USERNAME="piction"
...
# 
##############################################################################
#time psql -A -d "host=dba-postgres-prod-45.ist.berkeley.edu dbname=piction_transit port=5415 sslmode=prefer" -U "piction"  -c "select * from piction.bampfa_metadata_mv" -o ${TENANT}_pictionview_vw.tab

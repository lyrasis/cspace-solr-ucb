...
perl -i -pe 's/prod-42.ist.berkeley.edu port=53/dev-45.ist.berkeley.edu port=53/' solrdatasources/*/*.sh
perl -i -pe 's/prod-42.ist.berkeley.edu port=53/dev-45.ist.berkeley.edu port=53/' solrdatasources/cinefiles/scripts/*.sh
